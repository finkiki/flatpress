...
'descr' => '<strong>C’est tout.</strong>
		...
		<li>Bon blog ! <a href="%s">Connecte-toi maintenant</a></li>
...
[*]Obtiens le [url=https://wiki.flatpress.org/res:language target=_blank rel=external]pack de traduction[/url] pour ta langue.
[*]Tu peux aussi suivre FlatPress sur [url=https://fosstodon.org/@flatpress target=_blank rel=external]Mastodon[/url].
[/list]
