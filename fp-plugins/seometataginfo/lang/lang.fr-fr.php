...
$lang ['admin'] ['plugin'] ['seometataginfo'] = array(
	...
	'description1' => 'Le fichier <code>robots.txt</code> contrôle les robots d’un moteur de recherche et le comportement des robots sur ton blog FlatPress. ' . //
		'Ici, tu peux créer et modifier un fichier <code>robots.txt</code> pour l’optimisation des moteurs de recherche.',
	...
	'input_desc' => 'Insère la description :',
	'sample_desc' => 'Articles, guides et plugins relatifs à FlatPress',
	'input_keywords' => 'Insère les mots-clés :',
...
$lang ['plugin'] ['seometataginfo'] ['errors'] = array (
	-2 => 'Il n’y a pas de <code>robots.txt</code> ou il n’est pas possible de créer un <code>robots.txt</code> dans le répertoire principal du document HTTP.'
);
?>
