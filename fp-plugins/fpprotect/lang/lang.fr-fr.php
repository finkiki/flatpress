...
' . //
	...
	// Warning message
	'warning_allowUnsafeInline' => 'Avertissement : politique de sécurité du contenu -> cette politique contient « unsafe-inline », ce qui est dangereux dans la directive script-src.',
